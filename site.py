...
<head>
    <meta charset="utf-8">
    <title>Trailers Trailers Trailers!</title>
...
<div class="col-md-6 col-lg-4 movie-tile text-center" data-trailer-youtube-id="{trailer_youtube_id}" data-toggle="modal" data-target="#trailer">
    <img src="{poster_image_url}" width="320" height="480">
    <div class="overlay" id="{trailer_youtube_id}">
        <div class="text">
            Title: {movie_title}<br>
            Year: {movie_year}<br>
            Rating: {movie_rating}<br>
            Release Date: {movie_release_date}<br>
...
def create_movie_tiles_content(movies):
    ...
    for movie in movies:
        ...
        content += movie_tile_content.format(
             ...
             movie_imdb_rating = movie.rating
         )
    return content
